...
public class P0_FindElements_Practice {
    public static void main(String[] args) {
        ...
        // we are storing all of the links that are returned by FinElements method
        List<WebElement> lintOfLinks =  driver.findElements(By.xpath("//body//a"));


        //3. Print out the texts of all links
        for(WebElement each : lintOfLinks ){
        ...
        // here we storing linkOfLinks into int variable and we print it.
        int numberOfLinks = lintOfLinks.size();
